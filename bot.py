...
from telegram.ext import ApplicationBuilder, ContextTypes, PollHandler, CommandHandler
...
def main():
    ...
    # Optional: start polls via command in Topic 1
    app.add_handler(CommandHandler("poll", send_poll))

    print("Bot starting...")
    # run_polling internally manages the event loop
    app.run_polling()
